...
import Model.entity.interestRate.InterestRateOfShortTermCredit;

public class ShortTermCredit extends InterestRateOfShortTermCredit{
	private String bankName;
	private Boolean possibilityOfEarlyRepayment;
	private Boolean possibilitOfIncreasingCredit;
	
	public ShortTermCredit(String bankName, Double interestRate, Boolean possibilityOfEarlyRepayment, Boolean possibilitOfIncreasingCredit) {
		super(interestRate);
	...
	public String toString() {
		return "ShortTermCredit [bankName=" + bankName + "InterestRateOfShortTermCredit=" + getInterestRate() + ", possibilityOfEarlyRepayment=" + possibilityOfEarlyRepayment
