...
public class View17A {
	public static void main(String[] args) {
		...
		System.out.println("\"The entered numbers are the sides of an isosceles triangle\". This statement is " + Logic17A.isTriangle(number1, number2, number3) +".");	
		}
