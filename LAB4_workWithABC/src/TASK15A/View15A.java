...
public class View15A {
	public static void main(String[] args) {
		...
		System.out.println("\"The entered numbers are the sides of the triangle.\". This statement is " + Logic15A.isTriangle(number1, number2, number3) +".");	
		}
